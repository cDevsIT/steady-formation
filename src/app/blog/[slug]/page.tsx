  ...
  return (
    <div className="w-full min-h-screen bg-white pt-[65px]">
      <div className="max-w-[1280px] mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <aside className="hidden md:block md:col-span-1 bg-[#fafbfc] rounded-xl p-5 h-fit border border-[#ececec] min-w-[220px] max-w-[270px]">
            ...
            {tableOfContents.map((item, index) => (
              <li
                ...
                className={`border-b ${item.isActive ? 'border-[#7856FC]' : 'border-[#E4E7EC]'
                    ...
                    item.isActive ? 'pb-[46px] mb-4' : 'pb-4 mb-4'
                  }`}
              >
                <a
                  href={item.link}
                  className={`font-inter ${item.isActive
                    ? 'font-medium text-[#7856FC]'
                    : 'font-normal text-black'
                    } text-[16px] leading-[24px] hover:underline`}
                >
        ...
        <main className="md:col-span-2">
          <p className="text-[#7856FC] font-medium mb-3">Published 13 Jan 2024</p>
          <h2 className="font-inter text-[48px] leading-[60px] font-semibold tracking-[-0.02em] text-black mb-6">A conversation with Lucy Bond</h2>
          <p className="font-inter text-[20px] leading-[30px] font-normal text-[#475467] mb-6">Lucy Bond is an interior designer who started her career in New Zealand, working for large architectural firms. We chatted to her about design and life.</p>
          <h3 className="font-inter text-[30px] leading-[38px] font-semibold text-black mb-6" id="section1">Introduction</h3>
          <p className="font-inter text-[18px] leading-[28px] font-normal text-[#475467] mb-4">Mi tincidunt elit, id quisque ligula ac diam, amet. Vel etiam suspendisse morbi eleifend faucibus eget vestibulum felis. Dictum quis montes, sit sit. Tellus aliquam enim urna, etiam. Mauris posuere vulputate arcu amet, vitae nisi, tellus tincidunt. At feugiat sapien varius id.</p>
          <p className="font-inter text-[18px] leading-[28px] font-normal text-[#475467] mb-6">Eget quis mi enim, leo lacinia pharetra, semper. Eget in volutpat mollis at volutpat lectus velit, sed auctor. Porttitor fames arcu quis fusce augue enim. Quis at habitant diam at. Suscipit tristique risus, at donec. In turpis vel et quam imperdiet. Ipsum molestie aliquet sodales id est ac volutpat.</p>
          <img
          ...
          <p className="font-inter text-[18px] leading-[28px] font-normal text-[#475467] mb-6">
          ...
          <h3 className="font-inter text-[30px] leading-[38px] font-semibold text-black mb-6">Software and tools</h3>
          ...
          <h3 className="font-inter text-[30px] leading-[38px] font-semibold text-black mb-6">Other resources</h3>
          ...
          <ol className="list-decimal pl-6 mb-6">
            <li className="font-inter text-[18px] leading-[28px] font-normal text-[#475467] mb-2">
          ...
          <div className="bg-[#F9FAFB] rounded-2xl p-8 mb-12">
            <h3 className="font-inter text-[30px] leading-[38px] font-semibold tracking-[0px] text-black mb-[30px]">Conclusion</h3>
            ...
            <p className="font-inter text-[18px] leading-[28px] font-normal text-[#475467]">
        ...
        <aside className="hidden md:flex flex-col gap-6 md:col-span-1 min-w-[250px] max-w-[320px]">
          ...
          <div className="bg-[#EBE8FF] rounded-xl p-6 flex flex-col">
          ...
          <div className="bg-white rounded-xl p-6 flex flex-col items-center border border-[#E4E7EC]">
          ...
          <div className="bg-[#240D68] rounded-xl pt-6 px-6 pb-0 flex flex-col items-center text-center">
            <span className="font-inter font-semibold text-[20px] leading-[28px] text-white mb-5 w-full text-left">Launch Your U.S. Company</span>
            ...
            <img src="/blog-details/launch-company-US-sidebar-image.png" alt="Launch US Company" className="w-[160px] h-auto mx-auto mb-0" />
          </div>
        </aside>
      </div>

      {/* New Section Outside 3-Column Layout */}
      <section className="w-full max-w-[1280px] mx-auto mt-28 mb-36 px-4 md:px-0">
