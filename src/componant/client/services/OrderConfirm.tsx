        ...
        <div className="flex justify-center items-center min-h-screen bg-white py-8 px-2">
            <div className="bg-gray-100 rounded-2xl max-w-[717px] w-full p-6 sm:p-10">
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <h2 className="text-[24px] lg:text-[30px] font-semibold text-center mb-2"> Congrats! Your Order is Confirmed!</h2>
                    <p className="text-[#6B7280] text-center mb-4 text-base font-normal">Thank you for choosing Steady Formation! We’ve received your payment and will now guide you through the next steps</p>
