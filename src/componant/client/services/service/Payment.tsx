'use client';
import FunnelSidebar from "@/componant/funnel/Comp/FunnelSidebar";
import { dataState } from "@/componant/funnel/Funnel";
import { countries } from "@/componant/funnel/funnel.type";
import { ChildComponentProps } from "@/componant/funnel/SecondFunnel";
import { CustomFormData } from "@/componant/ui/FormSample";
import { FunnelHeading } from "@/componant/ui/FunnelHeading";
...
const Payment: React.FC<ChildComponentProps> = ({ handleFormSubmit }) => {
    ...
    const handleSubmit = (data: CustomFormData) => {
        router.push("/client/services/order-confirmed");
    ...
    const handleContinueWithLink = (isWithLink: boolean) => {
        ...
        if (handleFormSubmit) {
            router.push("/client/services/order-confirmed");
            handleFormSubmit({ stepPayment: { paymentOption }, isPaymentComplete: true })
        }
    };
