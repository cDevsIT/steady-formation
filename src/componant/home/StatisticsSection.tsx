            ...
            <div className="max-w-[1512px] mx-auto">
                <div className="flex flex-col lg:flex-row lg:flex lg:items-center justify-center gap-12">
                    ...
                    <div className="grid grid-cols-2 gap-6 flex-shrink-0">
                        ...
                        {/* Companies Formed */}
                        <div className="bg-[#FEFBE8] p-4 lg:p-8 rounded-2xl">
                            <div className="text-[36px] lg:text-[48px] leading-[44px] lg:leading-[60px] font-bold text-[#EAAA08] mb-2">500+</div>
                            <div className="text-black font-medium leading-tight">
                        ...
                        {/* Success Rate */}
                        <div className="bg-[#EDFCF2] p-4 lg:p-8 rounded-2xl">
                            <div className="text-[36px] lg:text-[48px] leading-[44px] lg:leading-[60px] font-bold text-[#16B364] mb-2">99.9%</div>
                    ...
                    <div className="flex-1 max-w-[594px]">
                        <h2 className="text-[30px] lg:text-[48px] leading-[38px] lg:leading-[60px] font-bold text-gray-900 mb-6">
